...
The raw dataset containing the apartment listings (`model/RENT_APARTMENT_RM_raw.csv`) was obtained from the website 
https://www.portalinmobiliario.com/ through web scraping using `Selenium` and `BeautifulSoup`.  
